...
function preload(){
  ...
  //LaserSnd=loadSound("sounds/Lasersound.mp3");
}
...
function setup() {
 ...
 spaceship.setCollider("rectangle",0,0,1000,1000)
 spaceship.scale=0.2 ;
...
var audio = new Audio('sounds/Lasersound.mp3');
audio.play();
...
function spawnfireball(){
    if (frameCount % 90 === 0){
      ...
      fireball.scale=0.2;
      fireball.debug=true;
      fireball.setCollider("circle",0,0,500)
